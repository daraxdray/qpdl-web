...
$(function () {
    ...
    $(document).on('click', '#add_row', function () {
        ...
        html_code += '<div class="col-md-2">' +
            ...
            '<div class="input-group">' +
            '<input type="text" onkeypress="return cdp_soloNumeros(event)"  name="order_item_fixed_value[]" id="order_item_fixed_value' + count + '" class="form-control input-sm number_only order_item_fixed_value" data-toggle="tooltip" data-placement="bottom" title="Fixed Charge"  value="0"/>' +
            '</div>' +
            '</div>' +
            '</div>';
...
function cdp_cal_final_total() {
    ...
    var sumador_max_fixed_charge = 0;
    ...
    for (var i = 1; i <= count; i++) {
        ...
        sumador_max_fixed_charge += fixed_value_item;
    ...
    $('#fixed_value_label').html(sumador_max_fixed_charge.toFixed(2));
    $('#sumador_max_fixed_charge').val(sumador_max_fixed_charge.toFixed(2));
