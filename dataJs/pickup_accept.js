...
function cdp_cal_final_total() {
    ...
    var total_envio = (sumador_total - total_descuento) + total_seguro + total_impuesto + total_impuesto_aduanero + max_fixed_charge + total_valor_declarado + reexpedicion_value;
