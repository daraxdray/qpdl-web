...
<head>
<meta charset="utf-8">
<title>Home | <?php echo $core->site_name ?></title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
        ...
        <div class="wrapper-box">
            <div class="content-wrapper">
                ...
                <div class="text-widget sidebar-widget">
                    <div class="logo"><a href="#"><img src="assets2/images/logo.png" alt=""></a></div>
                ...
                <div class="contact-widget">
                    ...
                    <div class="icon-box">
                        ...
                        <div class="text"><strong>Email</strong><a href="tel:(+61)32456789790">supportyou@deprixa.com</a></div>
                    </div>
                </div>
                <!-- Link Btn -->
    ...
    <section class="banner-section">
            ...
            <div class="option-box">
                ...
                <div class="order-form-area">
                    <div class="wrapper-box">
                        ...
                        <form class="order-form" method="POST" name="ib_form" id="ib_form">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                            <select class="selectpicker" name="trackingType" id="trackingType"> 
                                    <option value="*">Type of Tracking *</option>
                                    <option value="1">Shipments</option>
        ...
        <div class="swiper-container banner-slider">
            <div class="swiper-wrapper">
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(assets2/images/main-slider/bike1.jpg);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                <h4 class="shadow-1 shadow">We ensure to do your </h4>
                                <h1>Pickup & Deliver at Ease</h1>
                                <div class="text">Get started with us to enjoy the experience of speed, safe delivery.</div>
                                <div class="link-box">
                                    <a class="theme-btn btn-style-one" href="sign-up.php" ><span><i class="flaticon-up-arrow"></i>Get Started</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(assets2/images/main-slider/image-2.jpg);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                <h4>Track any delivery</h4>
                                <h1>At any poin in time</h1>
                                <div class="text">Get started with us to enjoy the experience of speed, safe delivery.</div>
                                <div class="link-box">
                                <a class="theme-btn btn-style-one" href="sign-up.php" ><span><i class="flaticon-up-arrow"></i>Get Started</span></a>
                                </div>
                ...
                <!-- Slide Item -->
                <div class="swiper-slide" style="background-image: url(assets2/images/main-slider/image-3.jpg);">
                    <div class="content-outer">
                        <div class="content-box">
                            <div class="inner text-center">
                                <h4>Internationally Delivery Made Easy </h4>
                                <h1>All goods properly stored</h1>
                                <div class="text">Get started with us to enjoy the experience of speed, safe delivery.</div>
                                <div class="link-box">
                                <a class="theme-btn btn-style-one" href="sign-up.php" ><span><i class="flaticon-up-arrow"></i>Get Started</span></a>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-3 service-block-one">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <h4>Air Freight</h4>
                        <div class="text">Your goods can get to you using our air media from different location around the world to your doorstep</div>
                        <div class="read-more-btn"><a href="#" class="link"><i class="flaticon-up-arrow"></i>____</a></div>
                        <div class="count"><span>01</span></div>
                        <div class="image" data-parallax='{"y": 30}'><img src="assets2/images/resource/image-1.png" alt=""></div>
                    </div>
                </div>
                <div class="col-lg-3 service-block-one">
                    <div class="inner-box wow fadeInDown" data-wow-duration="1500ms">
                        <h4>Ocean Freight</h4>
                        <div class="text">We also provide logistic services on the ocean - with assurance of speed and security</div>
                        <div class="read-more-btn"><a href="#" class="link"><i class="flaticon-up-arrow"></i>____</a></div>
                        <div class="count"><span>02</span></div>
                        <div class="image" data-parallax='{"y": 30}'><img src="assets2/images/resource/image-2.png" alt=""></div>
                    </div>
                </div>
                <div class="col-lg-3 service-block-one">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <h4>Land Freight</h4>
                        <div class="text">Our land transport is also available for you, easy, faster and safe</div>
                        <div class="read-more-btn"><a href="#" class="link"><i class="flaticon-up-arrow"></i>___</a></div>
                        <div class="count"><span>03</span></div>
                        <div class="image" data-parallax='{"y": 30}'><img src="assets2/images/resource/image-3.png" alt=""></div>
                    </div>
                </div>
                <div class="col-lg-3 service-block-one">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
    ...
    <!-- About Section -->
    <section class="about-section" style="background-image: url(assets2/images/background/bg-1.jpg);">
        <div class="auto-container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="sec-title">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="content">
                                    <a href="about.php"><h4>About <br>Our Company</h4></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1500ms">
                                ...
                                <div class="content">
                                    <a href="about.php"><h4>Statement of <br> Mission</h4></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1700ms">
                                ...
                                <div class="content">
                                    <a href="about.php"><h4>Statement of <br> Vision</h4></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="icon-box wow fadeInUp" data-wow-duration="1900ms">
                                ...
                                <div class="content">
                                    <a href="about.php"><h4>Statement of <br> Value</h4></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="image wow fadeInRight" data-wow-duration="1500ms"><img src="assets2/images/resource/image-1.jpg" alt=""></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="Whychooseus-section">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h5>We Aim to Contribute Well in <br>the Logistic company by ensuring that speed and security in all deliveries</h5>
            </div>
            <div class="row">
    ...
    <section class="work-process-section">
        <div class="bg" style="background-image: url(assets2/images/background/bg-2.jpg);"></div>
        <div class="auto-container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 work-process-block">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        ...
                        <a href="sign-up.php" class="readmore-link"><i class="flaticon-up-arrow"></i>Get Started</a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 work-process-block">
    ...
    <!-- Industries Covered -->
    <!-- <section class="industries-covered" style="background-image: url(assets2/images/background/bg-3.jpg);">
            ...
            <div class="outer-container">
                <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "center": true, "margin": 0, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "600" :{ "items" : "1" }, "768" :{ "items" : "1" } , "992":{ "items" : "1" }, "1200":{ "items" : "1" }}}'>
                    <div class="text-block">
                        <div class="inner-box">
                            <div class="image" style="background-image: url(assets2/images/resource/image-2.jpg);">
                            </div>
                            <div class="content">
                    ...
                    <div class="text-block">
                        <div class="inner-box">
                            <div class="image" style="background-image: url(assets2/images/resource/image-4.jpg);">
                            </div>
                            <div class="content">
                                <div class="icon"><span class="flaticon-spaceship"></span></div>
                    ...
                    <div class="text-block">
                        <div class="inner-box">
                            <div class="image" style="background-image: url(assets2/images/resource/image-5.jpg);">
                            </div> 
                            <div class="content">
        ...
        <div class="auto-container">
            ...
            <div class="row m-0">
                ...
                <div class="col-lg-4 col-md-6 pricing-block style-two">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms" style="background-image: url(assets2/images/resource/image-3.jpg);">
    ...
    <section class="facts-section" id="facts">
        <div class="auto-container">
            <div class="wrapper-box" style="background-image: url(assets2/images/background/bg-4.jpg);">
                <div class="shape">
                    <div class="shape-one"><img src="assets2/images/resource/image-4.png" alt=""></div>
                    <div class="shape-two"><img src="assets2/images/resource/image-5.png" alt=""></div>
                    <div class="shape-three"><img src="assets2/images/resource/image-6.png" alt=""></div>
                    <div class="shape-four"><img src="assets2/images/resource/image-7.png" alt=""></div>
                    <div class="shape-five"><img src="assets2/images/resource/image-8.png" alt=""></div>
                </div>
                <div class="sec-title text-center light">
                    ...
                    <div class="row">
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    <div class="icon"><img src="assets2/images/icons/icon-3.png" alt=""></div>
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    <div class="icon"><img src="assets2/images/icons/icon-4.png" alt=""></div>
                                    <div class="count-outer count-box">
                        ...
                        <div class="column counter-column col-md-6">
                            <div class="inner wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                                <div class="content">
                                    <div class="icon"><img src="assets2/images/icons/icon-5.png" alt=""></div>
                                    <div class="count-outer count-box">
            ...
            <div class="theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 30, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 6000, "smartSpeed": 1000, "responsive":{ "0" :{ "items": "1" }, "600" :{ "items" : "1" }, "768" :{ "items" : "2" } , "992":{ "items" : "2" }, "1200":{ "items" : "3" }}}'>
                <div class="testimonial-block">
                    <div class="inner-box">
                        ...
                        <div class="author-thumb">
                            <img src="assets2/images/resource/author-1.jpg" alt="">
                ...
                <div class="testimonial-block">
                    <div class="inner-box">
                        ...
                        <div class="author-thumb">
                            <img src="assets2/images/resource/author-2.jpg" alt="">
                            <div class="quote"><span class="flaticon-right-quote"></span>
                            </div>
                        </div>
                        <h4>Lillian Grace</h4>
                ...
                <div class="testimonial-block">
                    <div class="inner-box">
                        <div class="text">I only use Deprixa Logistics
                            for my shipping needs. My clients
                            have all come to expect the
                            excellent shipping.
                        </div>
                        <div class="author-thumb">
                            <img src="assets2/images/resource/author-3.jpg" alt="">
                            <div class="quote"><span class="flaticon-right-quote"></span>
                            </div>
                        </div>
                        <h4>Roman Dexter</h4>
        ...
        <div class="auto-container">
            ...
            <div class="row">
                <div class="news-block-one col-lg-4">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="blog-details.html"><img src="assets2/images/resource/news-1.jpg" alt=""></a>
                        ...
                        <div class="overlay">
                            <div class="image">
                                <a href="blog-details.html"><img src="assets2/images/resource/news-1-2.jpg" alt=""></a>
                                <div class="date">25 <br> Jun</div>
                            </div>
                            <div class="lower-content">
                                <div class="category"><i class="fas fa-folder"></i> Freight Management</div>
                ...
                <div class="news-block-one col-lg-4">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="blog-details.html"><img src="assets2/images/resource/news-2.jpg" alt=""></a>
                        ...
                        <div class="overlay">
                            <div class="image">
                                <a href="blog-details.html"><img src="assets2/images/resource/news-2-2.jpg" alt=""></a>
                                <div class="date">14 <br> May</div>
                            </div>
                            <div class="lower-content">
                                <div class="category"><i class="fas fa-folder"></i> Industry News</div>
                ...
                <div class="news-block-one col-lg-4">
                    <div class="inner-box wow fadeInUp" data-wow-duration="1500ms">
                        <div class="image">
                            <a href="blog-details.html"><img src="assets2/images/resource/news-3.jpg" alt=""></a>
                        ...
                        <div class="overlay">
                            <div class="image">
                                <a href="blog-details.html"><img src="assets2/images/resource/news-3-2.jpg" alt=""></a>
                                <div class="date">05 <br> May</div>
                            </div>
                            <div class="lower-content">
                                <div class="category"><i class="fas fa-folder"></i> Warehousing</div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/Transida2/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 May 2022 14:01:56 GMT -->
</html>
