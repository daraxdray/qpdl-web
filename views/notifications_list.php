											...
											<div class="d-flex">
												<div class="mr-auto">
													<div class="form-group">
														<button type="button" onclick="cdp_updateNotificationsRead();" class="btn btn-success btn btn-sm"><i class="fa fa-check" aria-hidden="true"></i> Mark all as read</button>
													</div>
												</div>
											</div>
										</div>
