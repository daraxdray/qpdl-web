                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="custom-select form-control" id="document_type" name="document_type" value="<?php echo $row->document_type; ?>">
                                                                ...
                                                                <?php if ($row->document_type == 'PASSPORT') {
                                                                    echo 'selected';
                                                                } ?>
                                                                >PASSPORT</option>                                                                          
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="document_number" name="document_number" value="<?php echo $row->document_number; ?>" placeholder="Document number">
                                                        </div>
                                                    </div>
                                                </div>
