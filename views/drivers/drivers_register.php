...
<body>
    ...
    <div id="main-wrapper">
        ...
        <?php include 'views/inc/topbar_register.php'; ?>
                    ...
                    <div class="col-lg-10 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form enctype="multipart/form-data" class="form-horizontal form-material" id="save_user" name="save_user" method="post">
                                    <section>

                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="firstName1"><?php echo $lang['user_manage3'] ?>(username must be in lowercase)</label>
                                                    <input type="text" class="form-control" id="username" name="username" placeholder="<?php echo $lang['user_manage3'] ?>">
                                                    <input type="hidden" class="form-control" id="reloadForm" name="reloadForm" value="1">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">                                                
                                                    ...
                                                    <select name="country[]" id="country1" class="form-control pl-5" onchange="getStates(this)">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">                                                
                                                    ...
                                                    <select name="city" id="city1" name="city[]" class="form-control pl-5" >
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"  placeholder="<?php echo $lang['user_manage12'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="phoneNumber1"><?php echo $lang['user_manage13'] ?></label>
                                                    <input type="text" class="form-control"  placeholder="<?php echo $lang['user_manage13'] ?>">
                                                </div>
                                            </div> -->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="landmark" id="landmark" placeholder="Your Landmark">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="custom-control custom-checkbox">
                                                        <input type="hidden" class="custom-control-input" name="notify" id="notify" value="1">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-primary btn-confirmation" id="save_data" name="save_data" type="submit"><?php echo $lang['left186'] ?><span><i class="icon-ok"></i></span></button>
