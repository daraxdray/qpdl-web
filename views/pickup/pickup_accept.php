                                ...
                                <div class="card-body">
                                    ...
                                    if ($order_items) {
                                        ...
                                        foreach ($order_items as $row_item) {
                                            ...
                                            $total_envio = ($sumador_total - $total_descuento) + $total_impuesto + $total_seguro + $total_impuesto_aduanero + $max_fixed_charge + $total_valor_declarado + $row_order->total_reexp;
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" onkeypress="return cdp_soloNumeros(event)" name="order_item_fixed_value[]" id="order_item_fixed_value<?php echo $count_item; ?>" data-srno="1" class="form-control input-sm number_only order_item_fixed_value is-invalid" data-toggle="tooltip" data-placement="bottom" title="Fixed charge" value="0" />
