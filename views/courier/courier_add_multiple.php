...
if (isset($_POST["create_invoice"])) {
    ...
    for ($count = 0; $count < $_POST["total_item"]; $count++) {
        ...
        $insured = floatval($_POST["insured_value"]);
        ...
        $fixed_value_item = cdp_sanitize($_POST["order_item_fixed_value"][$count]);
        ...
        $total_seguro = $insured * $insurance / 100;

        $total_impuesto_aduanero = $total_peso * $c_tariffs;

        $total_envio = ($sumador_total - $total_descuento) + $total_impuesto + $total_seguro + $total_impuesto_aduanero + $total_valor_declarado + $max_fixed_charge + $total_reexp;
        ...
        $db->bind(':total_insured_value', $insured);
        ...
        $db->bind(':total_fixed_value',  cdp_sanitize($fixed_value_item));
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" onkeypress="return cdp_soloNumeros(event)" name="order_item_declared_value[]" id="order_item_declared_value1" data-srno="1" class="form-control input-sm number_only order_item_declared_value is-valid" data-toggle="tooltip" data-placement="bottom" title="Declared value" value="0" />
