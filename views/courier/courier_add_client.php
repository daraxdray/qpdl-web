...
$minCostTax = $settings->min_cost_tax;
$minCostDeclaredTax = $settings->min_cost_declared_tax;
if (isset($_POST["create_invoice"])) {
    ...
    if(!$success){
        header("location:courier_add_client.php");   
    }
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                            <table id="invoice-item-table" class="table">
                                                ...
                                                <input type="hidden" name="core_min_cost_tax" id="core_min_cost_tax" value="<?php echo $minCostTax; ?>" />
                                                <input type="hidden" name="core_min_cost_declared_tax" id="core_min_cost_declared_tax" value="<?php echo $minCostDeclaredTax; ?>" />
                                            </table>
