                                            ...
                                            <div class="card-header">
                                                <div class="shadow-sm pt-3 pl-3 pr-3 pb-1" style="background-color: #3e5569 !important;">
                                                    ...
                                                    <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                                                        ...
                                                        ?>
                                                            ...
                                                            <li class="nav-item">
                                                                <a data-toggle="pill" href="#paystack" class="nav-link active">
                                                ...
                                                <div class="tab-content bg-white">
                                                    ...
                                                    ?>
                                                        ...
                                                        <!-- PAYSTACK TAB-PANE -->
                                                        <div id="paystack" class="tab-pane show active fade pt-3">
                                                            <form id="paymentForm" style="padding: 40px">
                                                                <div class="form-group">
                                                                
                                                                    <label for="email">Email Address</label>
                                                                    <input type="email" id="email-address" value="<?= $userData->email?>" required />
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="first-name">First Name</label>
                                                                    <input type="text" id="first-name" value="<?= $userData->fname ?>" required />
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="last-name">Last Name</label>
                                                                    <input type="text" id="last-name" value="<?= $userData->lname?>" required />
                                                                </div>
