                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="pull-left">
                                            ...
                                            <p class="text-muted  m-l-5"><?php echo $row_order->order_home_delivery ?></p>
                                        </div>

                                    </div>
                                    <?php if($row_order->order_home_delivery == 'yes') { ?>
                                    <div class="col-md-4 " >
                                        <div class="pull-left">
                                        <h5> &nbsp;<b>Home Delivery Time</b></h5>
                                            <p class="text-muted  m-l-5"><?php echo $row_order->order_home_delivery_time ?></p>
                                        </div>
                                        ...
                                        <tbody id="projects-tbl">
                                            ...
                                            if ($order_items) {
                                                ...
                                                foreach ($order_items as $row_order_item) {
                                                    ...
                                                    $sumador_fixed_charge += $row_order_item->order_item_fixed_value;
                                                    $max_fixed_charge += $row_order_item->order_item_fixed_value;
                                                    ...
                                                    $sumador_fixed_charge = number_format($sumador_fixed_charge, 2, '.', '');
