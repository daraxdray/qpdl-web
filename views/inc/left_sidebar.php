		...
		<nav class="sidebar-nav idebar-collapse">
			...
			<?php } else if ($userData->userlevel == 3) { ?>
				<ul id="sidebarnav">
					...
					<?php } else { ?>
						<li class="sidebar-item"><a href="courier_list.php" class="sidebar-link"><i class="ti-package"></i><span class="hide-menu"> <?php echo $lang['shipmentlist'] ?> </span></a></li>

						<li class="sidebar-item"><a href="pickup_list.php" class="sidebar-link"><i class="mdi mdi-cube-send"></i><span class="hide-menu"> <?php echo $lang['left5'] ?> </span></a></li>
						<?php } ?>
