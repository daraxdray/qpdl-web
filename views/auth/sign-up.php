                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 col-md-7 mt-4 mt-sm-5 pt-2 pt-sm-3">
                                ...
                                <div class="login_page bg-white shadow rounded p-4">
									...
									<br><br>	
                                    <form class="login-form" id="new_register" name="new_register" method="post" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">                                                
                                                    ...
                                                    <select name="country" class="form-control pl-5" onchange="getStates(this)">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">                                                
                                                    ...
                                                    <select name="city" id="myState" class="form-control pl-5" >
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group position-relative">                                                
                                                    ...
                                                    <input type="text" class="form-control pl-5" placeholder="Your landmark" name="landmark" id="landmark" required>
                                                </div>
                                            </div>
											...
											<div class="col-md-12">
                                                <div class="form-group position-relative">                                               
                                                    <label><?php echo $lang['left144'] ?> <span class="text-danger">*(must be alphabets in lowercase)</span></label>
                                                    <i class="mdi mdi-account ml-3 icons"></i>
                                            ...
                                            <div class="card">
											<div class="card-body">
												<h4 class="card-title m-t-10">User driver license / National ID or International Passport</h4>
