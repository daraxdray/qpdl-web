        ...
        <table>
            ...
            if ($numrows > 0) {
                ...
                foreach ($data as $row) {
                    ...
                    $total_fixed_charge = number_format($row->total_fixed_value, 2, '.', '');
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo  number_format($row->total_fixed_value, 2, '.', ''); ?></td>
                ...
                <tr>
                    ...
                    <td><b><?php echo  number_format($sumador_fixed_charge, 2, '.', ''); ?></b></td>
